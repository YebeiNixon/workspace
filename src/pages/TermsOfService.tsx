          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-lg shadow-sm p-8 space-y-6">
              <div>
                ...
                <h2 className="text-2xl font-semibold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent mb-4">1. Acceptance of Terms</h2>
                ...
                <h2 className="text-2xl font-semibold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent mb-4">2. Service Description</h2>
                <p className="text-gray-700 mb-4">
                ...
                <h2 className="text-2xl font-semibold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent mb-4">4. Payment Terms</h2>
                <p className="text-gray-700 mb-4">
                ...
                <h2 className="text-2xl font-semibold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent mb-4">5. Data Ownership and Backup</h2>
                <p className="text-gray-700 mb-4">
                ...
                <h2 className="text-2xl font-semibold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent mb-4">6. Limitation of Liability</h2>
                <p className="text-gray-700 mb-4">
                ...
                <h2 className="text-2xl font-semibold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent mb-4">7. Termination</h2>
                <p className="text-gray-700 mb-4">
                ...
                <h2 className="text-2xl font-semibold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent mb-4">8. Contact Information</h2>
